...
# Lancement du modéle
if [[ $run != false ]]; then
    javac Model.java Population.java Individual.java Sigmoid.java Influences.java AbstractPractice.java IdealPractice.java NormPractice.java RealPractice.java Economy.java Identity.java AlternativePractice.java References.java Evaluation.java Percentage.java Accounts.java
    if [[ $? != 0 ]]; then
        exit 0
    fi
